  ...
  return (
    <div className="flex flex-col h-screen bg-slate-950 text-slate-200 overflow-hidden">
      ...
      <div className="flex flex-col md:flex-row h-full">
        ...
        <aside className="hidden md:flex w-1/3 md:w-1/4 bg-slate-900 border-r border-slate-800 p-6 flex-col overflow-y-auto shrink-0 z-20">
        ...
        <main className="hidden md:block w-full md:w-2/4 bg-slate-950 relative border-r border-slate-800">
           {renderDrillPanel()}
        </main>

        <aside className="hidden md:block w-full md:w-1/4 bg-slate-900 p-6 overflow-hidden border-t md:border-t-0 border-slate-800">
          {renderUpgradePanel()}
        </aside>
